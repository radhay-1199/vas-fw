...
public class UdpHandlerOne implements Runnable {
  ...
  public UdpHandlerOne(McQueue queue, UdpBuffer[] arrayOfUdpBuffer, int receiveBufferSize, int checkUdpBufferArraySize, DatagramSocket serverSocket) {
  ...
  public void run() {
    System.out.println("starting UdpHandlerOne ");
    while (true) {
      try {
        getAvailableIndex();
