...
public class UdpHandlerThree implements Runnable {
  ...
  public UdpHandlerThree(McQueue queue, UdpBuffer[] arrayOfUdpBuffer, int receiveBufferSize, int checkUdpBufferArraySize, DatagramSocket serverSocket) {
  ...
  public void run() {
    System.out.println("starting UdpHandlerThree ");
    while (true) {
      try {
        getAvailableIndex();
